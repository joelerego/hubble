				...
				<Grid item={true} lg={4}>
					<p>
						<img
							...
							src="hubble/assets/images/hubble.png"
							height="50px"
						/>
					</p>
					<Typography className={classes.about}>
						Hubble offers an easy-to-integrate subscription management service
						to startups and businesses, with a variety of customer acquisition
						and retention tools.
					</Typography>
					<Typography className={classes.contact}>
						<Icon className={classes.icon}>email</Icon>
						<a href="mailto:contact@hubbsuite.com" className={classes.link}>
				...
				<Grid item={true} xs={12} lg={8}>
					<Grid container={true} spacing={0}>
						{groups.map((group, index) => (
							<Grid key={group.id} item={true} xs={12} sm={4} lg={2}>
